      ...
      <div className="sidebar__menu">
        ...
        <Link
          ...
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/employee' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          ...
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/customer' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          to="/dashboard/car"
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/car' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          to="/dashboard/repair"
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/repair' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          ...
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/component' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          to="/dashboard/report"
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/report' ? 'sidebar__menu-item--active' : ''
          }`}
        >
        ...
        <Link
          ...
          className={`sidebar__menu-item ${
            location.pathname === '/dashboard/regulation' ? 'sidebar__menu-item--active' : ''
          }`}
        >
